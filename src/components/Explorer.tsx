...
const Explorer = (props: any) => {
	const { initMenu,visible,isProjectPathExists,onClickItemExplorer,folderStack } = props;
	const { setProjectFolderClick,onCreateFolderCallBack } = props;
