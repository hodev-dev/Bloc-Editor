...
const LinkPreview = (props: any) => {
    ...
    return (
        <div className="flex flex-col">
            <div className={(true) ? "sticky top-0 left-0 text-black w-full  border" + theme_generate : "hidden border-none"} >
                <div className={"sticky top-0 w-full  z-40"}>
                    <input onChange={handleInput} value={(state && state.value) ? state.value : ''} className={"w-64 h-10 font-light align-middle" + theme_generate} type="text" />
                    ...
                    <button onClick={handleCopy} className={"h-10 w-32 border align-middle" + theme_generate}>Copy Link</button>
                    <button onClick={handleToggleScreenshot} className={"h-10 w-40 border align-middle" + theme_generate}>Show Screenshot</button>
                    <button onClick={handleSaveOffline} className={"h-10 w-40 border align-middle" + theme_generate}>Save Offline Version</button>
                    <button disabled={(state.offline) ? false : true} onClick={handleOpenOffline} className={"h-10 w-40 border align-middle" + theme_generate}>View Offline Version</button>
                </div>
            </div>
            ...
            <div className={"flex flex-row w-full h-full p-1"}>
                ...
                <div className={"ml-3" + ' ' + theme.default.bgc}>
